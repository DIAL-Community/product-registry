class BuildingBlocksController < ApplicationController
  ...
  def bb_fs 
    @building_blocks = BuildingBlock.name_contains(params[:search])
                                      .order(:name)
    @bb_desc = [{name: 'Analytics and Business Intelligence', desc: 'Provides data-driven insights about business processes, performance and predictive modelling.<br/><br/><strong>Examples:</strong> Microsoft Power BI, Tableau'},
      {name: 'Artificial Intelligence', desc: 'AI capabilities packaged as reusable services to perform work, extract insights from data, or provide other business capabilities.<br/><br/><strong>Example:</strong> Google TensorFlow'},
      {name: 'Client Case Management', desc: 'Registration of a client and the longitudinal tracking of services for the client, often across multiple service categories, providers and locations.<br/><br/><strong>Example:</strong> Dimagi CommCare'},
      {name: 'Collaboration Management', desc: 'Enables multiple users to simultaneously access, modify or contribute to a single activity, such as content creation, through a unified portal.<br/><br/><strong>Examples:</strong> Google Drive, Microsoft SharePoint'},
      ...
      {name: 'Content Management', desc: 'Supports the creation, editing, publication and management of digital media and other information.<br/><br/><strong>Examples:</strong> Drupal, Wordpress'},
      {name: 'Data Collection', desc: 'Supports data collection from humans, sensors and other systems through digital interfaces.<br/><br/><strong>Example:</strong> Open Data Kit (ODK)'},
      {name: 'Digital Registries', desc: 'Registries are centrally managed databases that uniquely identify persons, vendors, procedures, products and sites related to an organization or activity.<br/><br/><strong>Examples:</strong> DHIS2, iHIRS'},
      {name: 'eLearning', desc: 'Supports facilitated or remote learning through digital interaction between educators and students.<br/><br/><strong>Examples:</strong> MIT Open Course Ware, Moodle'},
      {name: 'eMarketplace', desc: 'Provides a digital marketing space where provider entities can electronically advertise & sell products & services to other entities (B2B) or end-customers (B2C).<br/><br/><strong>Example:</strong> Esoko'},
      {name: 'Geographic Information Services (GIS)', desc: 'Provides functionality to identify, tag and analyze geographic locations of an object, such as a water source, building, mobile phone or medical commodity.<br/><br/><strong>Example:</strong> Quantum GIS (QGIS)'},
      {name: 'Identification and Authentication', desc: 'Enables unique identification and authentication of users, organizations and other entities.<br/><br/><strong>Examples:</strong> Apache Syncope, MOSIP'},
      {name: 'Information Mediator', desc: 'Provides a gateway between external digital apps & ICT Building Blocks, ensuring implementation of standards, for integrating various ICT Building Blocks & apps.<br/><br/><strong>Example:</strong> OpenHIM'},
      {name: 'Messaging', desc: 'Facilitates notifications, alerts and two-way communications between applications and communications services, including SMS, USSD, IVR, email and social media platforms.<br/><br/><strong>Examples:</strong> RapidPro, Twilio'},
      {name: 'Mobility Management', desc: 'Services to securely enable employees’ use and management of mobile devices and applications in a business context.<br/><br/><strong>Example:</strong> Microsoft Group Policy Management'},
      {name: 'Payments', desc: 'Implements financial transactions (e.g., remittances, claims, purchases & payments, transactional info). Tracking costs utilities & audit trials.<br/><br/><strong>Examples:</strong> Apache Fineract, Bank EFT & online payments, PayPal'},
      {name: 'Registration', desc: 'Records identifiers and general information about a person, place or entity, typically for the purpose of registration  in specific services or programmes and tracking of that entity over time.<br/><br/><strong>Example:</strong> OpenSRP'},
      {name: 'Reporting and Dashboards', desc: 'Provides pre-packaged and custom presentations of data and summaries of an organization’s pre-defined key performance metrics, often in visual format.<br/><br/><strong>Examples:</strong> DHIS2, Tableau'},
      {name: 'Scheduling', desc: 'Provides an engine for setting up events based on regular intervals or specific combinations of status of several parameters in order to trigger specific tasks in an automated business process.<br/><br/><strong>Examples:</strong> Cron, Django Celery'},
      {name: 'Security', desc: 'Allows ICT admins to centrally configure & manage user access permissions to network resources, services, databases, apps and devices. Enables secure info exchange between apps.<br/><br/><strong>Example:</strong> OpenSSL'},
      {name: 'Shared Data Repositories', desc: 'Shared space to store data for a specified knowledge area that external applications use, often providing domain-specific functionality and data presentations.<br/><br/><strong>Example:</strong> World Bank Open Data'},
      {name: 'Terminology', desc: 'Registry of definitions with defined standards, synonyms for a particular domain of knowledge (eg agriculture), used to facilitate semantic interoperability.<br/><br/><strong>Examples:</strong> Open Concept Lab'},
      {name: 'Workflow and Algorithm', desc: 'Optimize business processes by specifying rules that govern the sequence of activities executed, the type of info exchanged  to orchestrate the process flow from initiation to completion.<br/><br/><strong>Examples:</strong> Drools, Zapier'},
  ]
  end

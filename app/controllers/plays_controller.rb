...
class PlaysController < ApplicationController
  ...
  def update
    authorize(Playbook, :mod_allowed?)
    if play_params[:play_description].present? || play_params[:play_outcomes].present? ||
      play_params[:play_prerequisites].present?
  ...
  def play_params
    params.require(:play)
          .permit(:name, :slug, :play_desc, :description_html, :author, :version, :logo, :play_prerequisites,
                  :play_description, :play_outcomes, :playbook_id, :move_id, resources: %i[

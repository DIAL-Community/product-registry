...
RSpec.describe 'candidate_organizations', type: :request do
  path '/candidate_organizations/{id}/reject' do
    ...
    parameter name: :authenticity_token, in: :formData, type: :string, required: true,
              description: 'Token from an actual candidate organization form.'

    post(summary: 'Reject a candidate organization.') do
      tags 'Candidate Organization Controller'

      consumes 'multipart/form-data'
      produces 'application/json'
      response(201, description: 'Success') do
        let(:id) { '123' }
  ...
  path '/candidate_organizations/{id}/approve' do
    ...
    post(summary: 'Approve a candidate organization.') do
      tags 'Candidate Organization Controller'
  ...
  path '/candidate_organizations' do
    get(summary: 'Get the list of all available candidate organization.') do
      tags 'Candidate Organization Controller'
    ...
    post(summary: 'Propose a new candidate organization.') do
      tags 'Candidate Organization Controller'
      ...
      parameter name: 'g-recaptcha-response', in: :formData, type: :string, required: true,
                description: 'Response from recaptcha. Generate this by clicking the recaptcha and see the network op.'
  ...
  path '/candidate_organizations/{id}' do
    ...
    get(summary: 'Find a single candidate organization by their id.') do
      tags 'Candidate Organization Controller'
    ...
    patch(summary: 'Update a candidate organization by their id.') do
      tags 'Candidate Organization Controller'

      consumes 'multipart/form-data'
      produces 'application/json'

      parameter name: 'candidate_organization[name]', in: :formData, type: :string, required: true,
                description: 'The name of the candidate organization.'
      parameter name: :authenticity_token, in: :formData, type: :string, required: true,
                description: 'Token from an actual candidate organization form.'
      parameter name: 'g-recaptcha-response', in: :formData, type: :string, required: true,
                description: 'Response token recaptcha. Generate this by clicking the recaptcha and see the network op.'
      response(200, description: 'Success') do
        let(:id) { '123' }
    ...
    delete(summary: 'Delete candidate organization by their id.') do
      tags 'Candidate Organization Controller'
  ...
  path '/candidate_organization_duplicates' do
    get(summary: 'Find duplicates of candidate organization.') do
      tags 'Candidate Organization Controller'

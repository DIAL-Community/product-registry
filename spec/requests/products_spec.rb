...
RSpec.describe 'products', type: :request do
  path '/products/count' do
    get(summary: 'Count total number of products.') do
  ...
  path '/products' do
    get(summary: 'List all available products.') do
      tags 'Product Controller'
    ...
    post(summary: 'Create a new product.') do
      tags 'Product Controller'
  ...
  path '/products/{id}' do
    ...
    get(summary: 'Find a product by their id.') do
      tags 'Product Controller'
      response(200, description: 'successful') do
        let(:id) { '123' }
    ...
    patch(summary: 'Update a product by their id.') do
      tags 'Product Controller'
      consumes 'multipart/form-data'
      produces 'application/json'
    ...
    delete(summary: 'Delete a product by their id.') do
      tags 'Product Controller'
      consumes 'multipart/form-data'
      produces 'application/json'
  ...
  path '/product_duplicates' do
    get(summary: 'Find duplcate of products.') do
      tags 'Product Controller'
  ...
  path '/productlist' do
    get(summary: 'Export products in standard json format.') do
      tags 'Product Controller'

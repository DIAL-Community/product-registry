...
RSpec.describe 'building_blocks', type: :request do
  path '/building_blocks/count' do
    get(summary: 'Count number of current building blocks.') do
  ...
  path '/building_blocks' do
    get(summary: 'List of all existing building blocks in the database.') do
      tags 'Building Block Controller'
  ...
  path '/building_blocks' do
    post(summary: 'Create a new building block.') do
      tags 'Building Block Controller'
  ...
  path '/building_blocks/{id}' do
    ...
    get(summary: 'Find a single building block by their id.') do
      tags 'Building Block Controller'
    ...
    patch(summary: 'Update a single building block object.') do
      tags 'Building Block Controller'
    ...
    delete(summary: 'Delete a single building block object.') do
      tags 'Building Block Controller'
  ...
  path '/building_block_duplicates' do
    get(summary: 'Find duplicates of building block object.') do
      tags 'Building Block Controller'

...
RSpec.describe('Sustainable Development Goals V1 API', type: :request) do
  path '/api/v1/sdgs/{slug}' do
    get 'Retrieves an sustainable development goals.' do
  ...
  path '/api/v1/sdgs' do
    get 'Search for sustainable development goals.' do
      tags 'Sustainable Development Goals'
      produces 'application/json'

...
RSpec.describe 'sustainable_development_goals', type: :request do
  path '/sustainable_development_goals/count' do
    get(summary: 'Count available sustainable development goal.') do
      tags 'SDG Controller'
  ...
  path '/sustainable_development_goals' do
    get(summary: 'List all available sustainable development goals') do
      tags 'SDG Controller'
  ...
  path '/sustainable_development_goals/{id}' do
    ...
    get(summary: 'Find a sustainable development goal by their id.') do
      tags 'SDG Controller'
      response(200, description: 'successful') do
        let(:id) { '123' }

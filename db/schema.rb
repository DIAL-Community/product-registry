...
ActiveRecord::Schema.define(version: 20_220_316_170_226) do
  ...
  create_table 'audits', force: :cascade do |t|
    ...
    t.index %w[action id version], name: 'auditable_index'
    t.index %w[associated_type associated_id], name: 'associated_index'
    t.index ['created_at'], name: 'index_audits_on_created_at'
    t.index %w[user_id user_role], name: 'user_index'
  end
  ...
  create_table 'move_descriptions', id: :bigint, default: lambda {
                                                            "nextval('task_descriptions_id_seq'::regclass)"
                                                          }, force: :cascade do |t|
  ...
  create_table 'organizations_sectors', id: false, force: :cascade do |t|
    ...
    t.bigint 'organization_id', null: false
    t.index %w[organization_id sector_id], name: 'org_sectors', unique: true
    t.index %w[sector_id organization_id], name: 'sector_orcs', unique: true
  end
  ...
  create_table 'play_moves', id: :bigint, default: lambda {
                                                     "nextval('play_tasks_id_seq'::regclass)"
                                                   }, force: :cascade do |t|
    t.bigint 'play_id'
    t.string 'name', null: false
    t.string 'slug', null: false
  ...
  create_table 'plays_building_blocks', force: :cascade do |t|
    ...
    t.index %w[building_block_id play_id], name: 'bbs_plays_idx', unique: true
    t.index ['building_block_id'], name: 'index_plays_building_blocks_on_building_block_id'
    t.index %w[play_id building_block_id], name: 'plays_bbs_idx', unique: true
  ...
  create_table 'plays_products', force: :cascade do |t|
    t.bigint 'play_id'
    t.bigint 'product_id'
    t.index %w[play_id product_id], name: 'plays_products_idx', unique: true
    t.index ['play_id'], name: 'index_plays_products_on_play_id'
    t.index %w[product_id play_id], name: 'products_plays_idx', unique: true
  ...
  create_table 'plays_subplays', force: :cascade do |t|
    ...
    t.integer 'order'
    t.index %w[parent_play_id child_play_id], name: 'play_rel_index', unique: true
  end
  ...
  create_table 'sectors', force: :cascade do |t|
    ...
    t.index %w[slug origin_id parent_sector_id locale], name: 'index_sector_slug_unique', unique: true
  end
  ...
  create_table 'use_case_steps_workflows', id: false, force: :cascade do |t|
    ...
    t.index %w[use_case_step_id workflow_id], name: 'use_case_steps_workflows_idx', unique: true
    t.index %w[workflow_id use_case_step_id], name: 'workflows_use_case_steps_idx', unique: true
  end
  ...
  create_table 'workflows_building_blocks', id: false, force: :cascade do |t|
    t.bigint 'workflow_id', null: false
    t.bigint 'building_block_id', null: false
    t.index %w[building_block_id workflow_id], name: 'bbs_workflows', unique: true
    t.index %w[workflow_id building_block_id], name: 'workflows_bbs', unique: true
  end

  create_table 'workflows_use_cases', id: false, force: :cascade do |t|
    t.bigint 'workflow_id', null: false
    t.bigint 'use_case_id', null: false
    t.index %w[use_case_id workflow_id], name: 'usecases_workflows', unique: true
    t.index %w[workflow_id use_case_id], name: 'workflows_usecases', unique: true
  end

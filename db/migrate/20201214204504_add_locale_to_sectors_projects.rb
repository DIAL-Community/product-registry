class AddLocaleToSectorsProjects < ActiveRecord::Migration[5.2]
  def change
    ...
    remove_index :sectors, [:slug, :origin_id, :parent_sector_id]
    add_index :sectors, [:slug, :origin_id, :parent_sector_id, :locale], unique: true, name: 'index_sector_slug_unique'

class ChangeProductRelationshipToEnum < ActiveRecord::Migration[5.1]
  def up
    ...
    change_column :product_product_relationships, :relationship_type,\
                  " relationship_type USING "\
                  " (CASE relationship_type "\
                  "   WHEN 'composed' THEN 'composed'::relationship_type "\
                  "   WHEN 'interoperates' THEN 'interoperates'::relationship_type "\
                  " END)", null: false
  end
  ...
  def down
    change_column :product_product_relationships, :relationship_type,\
                  ...
                  "   WHEN 'interoperates' THEN 'interoperates' "\
                  " END)", null: false
